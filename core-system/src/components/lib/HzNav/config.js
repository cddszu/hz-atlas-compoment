export const platforms = [
    ...
    // {key: 'APP', name: '应用平台', icon: 'icon-applicationplatform'},
  ...
  export const urlMap = [
    ...
    {url: '/root/main/serviceMgt', permission: ['gdb_search, save_search', 'gdb_search, gs_service_save'], platform: 'GAP', name: '服务管理'},
    // {url: '/root/main/serviceMgt', permission: 'manager_project', platform: 'GAP', name: '管理项目'},
    {url: '/graph', permission: 'gdb_search', platform: 'GAP', target: '_blank', name: '图查询'},
    {url: '/graph/sence', permission: 'gs_sceneExplore', platform: 'GAP', target: '_blank', name: '场景探索'},
    {url: '/root/main/graphConfig', permission: 'style', platform: 'GAP', name: '可视化配置'},
    {url: '/root/main/hyperlinkConfig', permission: 'hyperlink', platform: 'GAP', name: '超链接配置'},
    ...
    //应用平台
    {url: '/root/main/searchDoor/listPageConfig', permission: 'app_search_door', platform: 'DIP', name: '测试'},
    // 系统平台
