...
const UPDATE_ROLE_STATUS = 'UPDATE_ROLE_STATUS'
...
export const getRoleList = (filterObj = {}) => {
  ...
  const postConfig = {
    url: `${IS_MOCK}/crm-jj/api/auth/RoleResource/findAll`,
...
export const getRoleCount = (queryObj) => {
  ...
  const postConfig = {
    url: `${IS_MOCK}/crm-jj/api/role/findRoleCount`,
...
export const deleteRole = (id) => {
  return get({
    url: `${IS_MOCK}/crm-jj/api/auth/RoleResource/delRole?roleID=${id}`,
...
export const getRoleDetail = (id) => {
  return get({
    url: `${IS_MOCK}/crm-jj/api/auth/RoleResource/queryDetail?roleID=${id}`,
...
export const saveRole = (roleObj) => {
  return post({
    url: `${IS_MOCK}/crm-jj/api/auth/RoleResource/save`,
    bodyData: roleObj,
...
export const updateRole = (roleObj) => {
  return post({
    url: `${IS_MOCK}/crm-jj/api/auth/RoleResource/update`,
    bodyData: roleObj,
...
export const updateRoleStatus = (role, successCallback, failCallback) => {
  return post({
    url: `${IS_MOCK}/crm-jj/api/auth/RoleResource/updateStatus`,
    bodyData: role,
    actionType: UPDATE_ROLE_STATUS,
    successConfig: {
      message: '更新角色状态成功',
...
export const getPermissionTree = () => {
  return get({
    url: `${IS_MOCK}/crm-jj/api/auth/resource/findAll`,
