module.exports = function(router) {
  ...
  //   "roleName": ""
  // }
  router.post('/mock/crm-jj/api/auth/RoleResource/findAll', function (req, res, next) {
    res.json(
      {
        "success": true,
        "payload": {
  ...
  // 角色管理——角色详情 入参 roleID
  router.get('/mock/crm-jj/api/auth/RoleResource/queryDetail', function (req, res, next) {
    res.json({
      "success": true,
      "payload": {
        "id": 139,
  ...
  // 角色管理——删除角色 入参 roleID
  router.get('/mock/crm-jj/api/auth/RoleResource/delRole', function (req, res, next) {
    res.json({
      "success": false,
      "message": {
        "code": 10033,
  ...
  //   ]
  // }
  router.post('/mock/crm-jj/api/auth/RoleResource/save', function (req, res, next) {
    res.json(
      {
        "success": true
      }
