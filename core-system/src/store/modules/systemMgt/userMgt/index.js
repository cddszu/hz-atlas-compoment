...
export const getUserList = (filterObj = {}) => {
  ...
  const postConfig = {
    url:  `${IS_MOCK}/crm-jj/api/user/queryUser`,
...
export const deleteUser = (id) =>{
  return get({
    url: `${IS_MOCK}/crm-jj/api/user/delete?id=${id}`,
...
export const getUserDetail = (id) =>{
  return get({
    url: `${IS_MOCK}/crm-jj/api/user/details/${id}`,
...
export const saveUser = (userObj) =>{
  return post({
    url: `${IS_MOCK}/crm-jj/api/user/save`,
    bodyData: userObj,
...
const updateUserURL = `${IS_MOCK}/crm-jj/api/user/update`
...
export const resetPassword = (id) => {
  return get({
    url: `${IS_MOCK}/crm-jj/api/user/resetPassword?id=${id}`,
