...
export const getOrgList = (filterObj = {}) => {
  ...
  const postConfig = {
    url:  `${IS_MOCK}/crm-jj/api/auth/institution/query`,
...
export const getOrgTree = () => {
  const getConfig = {
    url: `${IS_MOCK}/crm-jj/api/auth/institution/tree`,
...
export const deleteOrg = (id) =>{
  return get({
    url: `${IS_MOCK}/crm-jj/api/auth/institution/delete?id=${id}`,
...
export const getOrgDetail = (id) =>{
  return get({
    url: `${IS_MOCK}/crm-jj/api/auth/institution/details/${id}`,
...
export const saveOrg = (orgObj) =>{
  return post({
    url: `${IS_MOCK}/crm-jj/api/auth/institution/save`,
    bodyData: orgObj,
    actionType: SAVE_ORG,
    successConfig: {
      message: '新增机构成功',
...
export const updateOrg = (orgObj) =>{
  return post({
    url: `${IS_MOCK}/crm-jj/api/auth/institution/update`,
    bodyData: orgObj,
