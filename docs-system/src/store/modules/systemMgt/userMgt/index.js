...
export const saveUser = (userObj, callback = () => {}) =>{
  return post({
...
export const updateUserStatus = (updateParam, successCallback) =>{
  return post({
    url: `${IS_MOCK}/crm-fd/api/user/updateStatus`,
    bodyData: updateParam,
