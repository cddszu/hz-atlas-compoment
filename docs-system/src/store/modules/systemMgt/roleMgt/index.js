...
export const deleteRole = (id) => {
  return get({
    url: `${IS_MOCK}/crm-fd/api/auth/RoleResource/delRole?roleID=${id}`,
...
export const getRoleDetail = (id) => {
  return get({
    url: `${IS_MOCK}/crm-fd/api/auth/RoleResource/queryDetail?roleID=${id}`,
...
// 新增（保存）角色
export const saveRole = (roleObj, callback = () => {}) => {
  return post({
    url: `${IS_MOCK}/crm-fd/api/auth/RoleResource/save`,
    bodyData: roleObj,
...
// 编辑（更新）角色
export const updateRole = (roleObj, callback = () => {}) => {
  return post({
    url: `${IS_MOCK}/crm-fd/api/auth/RoleResource/update`,
    bodyData: roleObj,
...
export const updateRoleStatus = (role, successCallback, failCallback) => {
  return post({
    url: `${IS_MOCK}/crm-fd/api/auth/RoleResource/updateStatus`,
    bodyData: role,
